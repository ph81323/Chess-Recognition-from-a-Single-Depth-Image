...
def readdata():
    normalpath = './chessData_2017410/chessman_white_knight/normal_white_knight_1.txt'
    chesspath = './chessData_2017410/chessman_white_knight/pointCloud_white_knight_1.txt'
    normal = []
