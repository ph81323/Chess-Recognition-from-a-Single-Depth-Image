function pcFromModel(OBJ,category,offset,threshold,ybias,zbias)
...
%     testpc(answer)
%     parameters(index,2)
    filename = ['/home/bonnie/pc_real_occlution/train/',category,'/result_',num2str(index+offset)];      
